...
vim.api.nvim_create_user_command('CppTerm', function ()
...
-------------------------------
vim.keymap.set('i', '<M-j>', '<ESC>:w<CR>:CppTerm<CR>', {silent = true, noremap = true})
vim.keymap.set('n', '<M-j>', ':w<CR>:CppTerm<CR>', {silent = true, noremap = true})
